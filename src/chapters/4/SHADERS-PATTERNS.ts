...
import vertexShader from './shaders/2/vertex.glsl?raw';
import fragmentShader from './shaders/2/fragment.glsl?raw';
...
if (sceneHtmlCanvas) {
    ...
    //MESH 
    const geometry = new THREE.PlaneGeometry(3, 3, 64 * 10, 64 * 10);
